...
export default function TiledHeader({
    ...
    return (
        <div className="flex border border-sky-500 w-full pt-2 pb-2 relative h-16" {...props}>
            ...
            <div className="flex items-end justify-center gap-4 mx-auto absolute left-1/2 transform -translate-x-1/2"> 
